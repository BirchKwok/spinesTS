...
class DenseNet(TorchModelMixin):
    """
    spinesTS DenseNet1D pytorch-model
    """
    def __init__(self, in_features, out_features, kernel_size=3, learning_rate=0.001, random_seed=0):
        super(DenseNet, self).__init__(seed=random_seed)
    ...
    def call(self):
        model = dense_net(self.out_features, kernel_size=self.kernel_size)
