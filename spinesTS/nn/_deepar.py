...
class DeepARStructure(nn.Module):
    def __init__(self, in_features, out_features, num_class, embedding_dim, lstm_hidden_dim, lstm_layers, lstm_dropout):
        """
        We define a recurrent network that predicts the future values of a time-dependent variable based on
        past inputs and covariates.
        """
        super(DeepARStructure, self).__init__()
